<?php
/* Template Name: Sales Content Fetched*/
?>
        ...
        <div class="container-fluid py-5 my-xl-5 z-1 cross-vertical-right">
            <div class="row py-lg-5 justify-content-center">
                <div class="col-lg-8 col-10 text-center">
                    ...
                    <div class="text-white mb-5"><?php the_content();?></div>
                </div>
                <div class="w-100"></div>
                    ...
                    <div class="tab-content" id="nav-tabContent">
                        <div class="tab-pane fade show active" id="nav-home" role="tabpanel"
                            ...
                            <script type="text/javascript"
                                src="https://lasara.formstack.com/forms/js.php/weightloss?nojquery=1&nojqueryui=1&nomodernizr=1">
                            </script>

                            <noscript><a href="https://lasara.formstack.com/forms/weightloss"
