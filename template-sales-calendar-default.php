<?php
/* Template Name: Sales Calendar Default */
?>
...
?>
<style>
   .sales-tab #nav-home-tab   .tab-desc{display: block !important;color: #fff;} 
    .fsBody,
                        ...
                        <div class="nav nav-tabs nav-pills" id="nav-tab" role="tablist">
                            <div class="nav-link" id="nav-home-tab" data-bs-toggle="tab_" data-bs-target="#nav-home" type="button" role="tab" aria-controls="nav-home" aria-selected="true">
                                <div class="row align-items-center h-100">
                                    ...
                                    <div class="col-auto">
                                        <h3>STEP 1</h3>
                                     <p class="tab-desc">Complete medical history form to be approved to start Semaglutide or Tirzepatide</p>
                                    </div>
                                </div>
                            </div>
