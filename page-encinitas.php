...
<section class="bg-img bg-overlay bg-top bg-overlay-left-full">
        <div class="container-fluid py-5 z-1 cross-vertical-right">
            <div class="row py-lg-5 text-center justify-content-center z-1">
                <div class="col-xl-12 col-md-12">
                    ...
                    LaSara Medical Group Encinitas, CA Office
                    </h1>
                </div>
                <ol class="breadcrumb">
                    <li><a href="<?php echo get_site_url() ?>">Home</a></li>
                    <li><a href="<?php echo get_site_url() ?>/contactus">Contact Us</a></li>
                    <li><a href="<?php echo get_site_url() ?>/encinitas">Encinitas</a></li>
                </ol>
    ...
    <section>
      <div class="container">
       ...
       <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d6688.229096000686!2d-117.260447!3d33.053451!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x80dc0b8edd42e101%3A0xd311abf34b6f0122!2s285%20N%20El%20Camino%20Real%2C%20Encinitas%2C%20CA%2092024!5e0!3m2!1sen!2sus!4v1659451237705!5m2!1sen!2sus" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade" class="location-map"></iframe>
          </div>
        </div>
      </div>
    </section>
              ...
              <div class="contact_location sticky-top pb-2">
                ...
                <div class="opening_hours_wrap">
                  ...
                  <div class="bottom-wrap mt-5">
                    ...
                    <a href="" class="btn btn-grad mb-5">760-266-8466</a>

                    <p>
                    
                     285 N EL Camino Real<br/>
                     Suite 211 - Encinitas, CA 92024<br/>
