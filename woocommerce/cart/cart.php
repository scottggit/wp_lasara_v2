...
<div class="testimonials fadeIn" style="margin-top:5rem;">
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-md-8">
              <div class="swiper js-testimonials-slider fadeInUp">
                <div class="swiper-wrapper">

                   <?php

      
                   if( have_rows('testimonial_section','option') ):
                   
             
                       while( have_rows('testimonial_section','option') ) : the_row();
