<?php
/* Template Name: Hardfactor FormStack*/
?>
                    ...
                    <div class="tab-content" id="nav-tabContent">
                        <div class="tab-pane fade show active" id="nav-home" role="tabpanel"
                            ...
                            <script type="text/javascript"
                                src="https://lasara.formstack.com/forms/js.php/hardfactor">
                            </script>

                            <noscript><a href="https://lasara.formstack.com/forms/js.php/hardfactor"
                                    title="Patient Information">Online Form - LaSara Medical &amp; Hard Factor - TRT</a></noscript>
                            <script type='text/javascript'>
