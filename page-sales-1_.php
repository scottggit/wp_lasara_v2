...
<div class="main-container">
        ...
        <div class="container-fluid py-5 my-xl-5 z-1 cross-vertical-right">
            <div class="row py-lg-5 justify-content-center">
                <div class="col-lg-6 col-10 text-center">
                    ...
                    <h1 class="text-white mb-5">Fill out the form below to receive a 15 minute Semaglutide complimentary consultation</h1>
                </div>
                <div class="w-100"></div>
    ...
    <section class="testimonial-section bg-secondary-light py-5 rad-bor-bottom rad-top animate__animated"
            ...
            <div class="testimonial_slick">
                ...
                <div class="card testimonial-item p-4 p-md-5">
                    ...
                    <div class="testimonial-author">
                        ...
                        <a href=" <?php echo get_sub_field('read_more'); ?>"
                            class="text-secondary font-bold videoPopup">Watch Video</a>
                    </div>
                </div>
