                    ...
                    <div class="tab-content" id="nav-tabContent">
                        <div class="tab-pane fade show active" id="nav-home" role="tabpanel"
                            ...
                            <script type="text/javascript"
                                src="https://lasara.formstack.com/forms/js.php/semaglutide_lund?nojquery=1&nojqueryui=1&nomodernizr=1">
                            </script>

                            <noscript><a href="https://lasara.formstack.com/forms/semaglutide_lund"
